# Generated by Django 5.0.6 on 2024-09-25 10:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estimate_date', models.DateField(default=datetime.date(2024, 9, 25))),
                ...
                ('shipping_charges', models.DecimalField(blank=True, decimal_places=2, default=None, max_digits=10, null=True)),
        ...
        migrations.CreateModel(
            name='EstimateItems',
            fields=[
                ('quoteitems_id', models.AutoField(primary_key=True, serialize=False)),
