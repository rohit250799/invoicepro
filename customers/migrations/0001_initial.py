    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('INDIVIDUAL', 'Individual'), ('ORGANIZATION', 'Organization')], default='INDIVIDUAL', max_length=70)),
                ...
                ('gst_treatment', models.CharField(choices=[('UNREGISTERED', 'Unregistered'), ('REGISTERED', 'Registered')], default='UNREGISTERED')),
